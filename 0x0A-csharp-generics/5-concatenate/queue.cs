...
class Queue<T>
{
    ...
    /// <summary>Joins the elements of the queue together if they're strings or characters.</summary>
    /// <returns>The result of the concatenation of the items in the queue.</returns>
    ...
    /// <summary>Returns the element at the front of the queue.</summary>
    ...
    /// <summary>Prints all elements in the queue.</summary>
    public void Print() {
        Node node;
